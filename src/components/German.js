...
<p class="text" ><p className="text-justify">For those who want to pursue their career in German language, we provide an effective and supportive learning environment. RMC Lingo always tries to associate the students with the applicable skills which improves and helps the students in any field they want to pursue.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <h4>Career Options
                                ...
                                <p class="text"><p className="text-justify">Multilingualism is important for aviation professionals as it helps them connect with passengers and improve customer service. In addition, speaking multiple languages improves one’s intercultural skills, which are essential for safety and service excellence.
...
minds. Furthermore, Germans have high per capita income and very low unemployment rates, which makes them a desirable workforce for businesses.</p>
